...
public class Point {
    ...
    /**
     * Creates a point from X Y Z (zoom) meters in Spherical Mercator
     * EPSG:900913
     *
     * @param meterX mx
     * @param meterY my
    ...
    /**
     * Gets pixel X of the EPSG:4326 pyramid by a specific zoom, converted from
     * lat/lon in WGS84
     *
     * @param zoom z
     * @return pixelX
    ...
    /**
     * Gets pixel Y of the EPSG:4326 pyramid by a specific zoom, converted from
     * lat/lon in WGS84
     *
     * @param zoom z
     * @return pixelY
    ...
    /**
     * Gets the X meter in Spherical Mercator EPSG:900913, converted from
     * longitude in WGS84
     *
     * @return meterX
     */
    ...
    /**
     * Gets the Y meter in Spherical Mercator EPSG:900913, converted from
     * latitude in WGS84
     *
     * @return meterY
     */
